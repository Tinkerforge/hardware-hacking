...
const VALUE_A_ON  = (1 << 0) | (1 << 2); // Pin 0 and 2 high
const VALUE_A_OFF = (1 << 0) | (1 << 3); // Pin 0 and 3 high
const VALUE_B_ON  = (1 << 1) | (1 << 2); // Pin 1 and 2 high
const VALUE_B_OFF = (1 << 1) | (1 << 3); // Pin 1 and 3 high
